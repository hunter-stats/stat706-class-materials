...
The primary improvement that would be done here is to change the link function to account for heavy tails. Perhaps robust regression would be a suitable technique here, or a link function that models an exponential response rather than a gaussian.

The effects of genres are somewhat difficult to interpret here. Genres themselves might be expressions of deeper underlying characteristics of films, and numerous external variables are not controlled for, e.g. marketing, the reputation of particular directors, and interactions among genres.
